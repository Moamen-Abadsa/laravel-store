...
<body class=" detail page ">
	...
	<main id="main" class="main-site">
		...
		<form action="{{ URL('rating/store/' . $store->id) }}" method="post" id="commentform" class="comment-form" novalidate="">
							<input type="hidden" name="_token" value="{{ csrf_token() }}">	<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
					<div class="wrap-product-detail">
						...
						<div class="detail-info">
          				 <h5 name="name">{{ $store->name }} </h5> 
						   <input type="hidden" name="name" class="form-control"value="{{ $store->name }}" type="number">
						 <h2 class="product-name">{{ $store->description }} </h2>
                            <div class="wrap-price"><span  class="product-price">${{ $store->price }}</span></div>
							<div class="wrap-price"><span class="product-price">${{ $store->discount }}</span></div>
							<input type="hidden" name="price" class="form-control"value="{{ $store->price }}" type="number">
